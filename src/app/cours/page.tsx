...
//         <h3 className="text-2xl font-semibold mb-6">20 Commentaires</h3>
...
//                 rows={3} // Utilisation de accolades pour indiquer un nombre
//               ></textarea>
...
//                 <strong className="text-[#1C1E53]">Courtney Henry</strong> • 20h
//               </p>
//               <p className="text-gray-800">
//                 Ultricies ultricies interdum dolor sodales. Vitae feugiat vitae
//                 vitae quis id consectetur.
//               </p>
//               {/* Bouton répondre */}
...
//           {/* Deuxième commentaire principal */}
//           <div className="flex items-start">
//             <div className="mr-4">
//               <img
//                 src="https://via.placeholder.com/48"
...
//             <div className="flex-1 bg-gray-100 p-4 rounded-lg shadow-md">
//               <p className="text-sm text-gray-600 mb-2">
//                 <strong className="text-[#1C1E53]">Theresa Webb</strong> • 10h
//               </p>
//               <p className="text-gray-800">
//                 Donec sed sed feugiat sit. Enim, urna euismod magna enim. Sit
//                 cras eget id sagittis consequat at.
//               </p>
//               <button className="mt-2 text-sm text-[#1C1E53]">répondre</button>
//             </div>
//           </div>
