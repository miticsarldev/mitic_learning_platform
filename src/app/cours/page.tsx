...
const ProgressBar = ({ onprogress }: { onprogress: number | null }) => {
  ...
  const filledSteps =
    onprogress !== null ? Math.round((onprogress / 100) * totalSteps) : 0;
      ...
      {[...Array(totalSteps)].map((_, index) => (
        <div
          ...
          className={`absolute top-0 left-${
            ...
            index < filledSteps ? "bg-[#25026B]" : "bg-gray-300"
          }`}
          style={{
        ...
        <main className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-6 py-8 px-4">
          ...
          <div className="md:col-span-3">
            ...
            <p className="text-gray-600 mt-2">
              ...
              sodales metus sed ex faucibus. Lorem ipsum dolor sit amet
              consectetur, adipisicing elit. Aliquid, ea obcaecati. Vel
              explicabo fuga, nam suscipit, aspernatur id ipsa ad dolores qui,
              magni consequuntur repudiandae placeat libero ex eum voluptatem!
            </p>
            ...
            <div className="mt-4 space-y-4">
              ...
              <div className="flex items-start bg-orange-100 p-4 rounded-lg">
                ...
                <p className="ml-4 text-gray-700">
                  Vestibulum vehicula risus nec arcu vehicula, at tincidunt
                  lorem vestibulum.
                </p>
              </div>
            </div>
            ...
            {/* Titre de la leçon */}
            <h2 className="text-2xl font-bold mt-6">Titre 1</h2>
            {/* Liste des éléments */}
            ...
            {/* Titre de la leçon */}
            <h2 className="text-2xl font-bold mt-6">Titre 2</h2>
            {/* Liste des éléments */}
            <ul className="list-disc pl-6 mt-4 text-gray-700">
              <li>Point clé 1 : Lorem ipsum dolor sit amet</li>
              <li>Point clé 2 : Consectetur adipiscing elit</li>
