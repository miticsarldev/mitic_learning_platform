...
import { ChevronRightIcon, DocumentDuplicateIcon } from '@heroicons/react/24/solid'; // Icône de copie
...
const UserProfile: React.FC = () => {
  ...
  <p className="text-lg font-semibold">Votre profil vu par un employeur</p>
  
  {/* Conteneur du texte et du bouton */}
  <div className="flex items-center mt-2">
    <p className="text-gray-700 text-center">
      J&apos;accepte de rendre mon profil avec les informations listées ci-dessous visibles auprès des employeurs inscrits
    </p>
    ...
    <div className="ml-4">
     ...
     <div className="bg-gray-100 min-h-screen p-6 w-full md:w-3/4 lg:w-3/4 mx-auto">
      ...
      <div className="bg-white p-4 rounded-lg shadow-md">
        ...
        <p className="text-sm text-gray-500">Votre profil est complet à 10%</p>
...
/>
        ...
        <InfoLine emptyCard="Vous n’avez pas encore ajouté d’expérience professionnelle
...
/>
  ...
  <p className="text-lg">Souhaitez-vous modifier d&apos;autres informations ?</p>
...
const InfoLine: React.FC<InfoLineProps> = ({ Icon, text, title, emptyCard }) => {
...
const InfoSection: React.FC<{ title: string }> = ({ title, children }) => (
