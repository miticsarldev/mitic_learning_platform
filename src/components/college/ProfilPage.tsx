...
<div className="bg-sky-50 rounded-xl p-10 shadow-md w-1/2 flex flex-col gap-6">
  ...
  <div className="flex items-center justify-center gap-3 mb-6">
    <UsersIcon className="h-8 w-8 text-blue-600" /> {/* Icône users avec taille augmentée */}
    <h2 className="text-2xl font-bold text-gray-800">Infos personnelles</h2> {/* Texte agrandi */}
  </div>
